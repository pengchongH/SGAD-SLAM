...
def render_gaussian_model_mask(gaussian_model, render_settings, mask,
                          override_means_3d=None, override_means_2d=None,
                          override_scales=None, override_rotations=None,
                          override_opacities=None, override_colors=None):
    """
    ...
    # print('means3Dafter', means3D.shape)
    means2D = means2D[mask]
    opacities = opacities[mask]
    shs = shs[mask]
    scales = gaussian_model.get_scaling()[mask]
    rotations = gaussian_model.get_rotation()[mask] if override_rotations is None else override_rotations[mask]
    ...
    render_args = {
        ...
        "colors_precomp": colors_precomp,
        "shs": shs,
        "scales": scales, # gaussian_model.get_scaling() if override_scales is None else override_scales,
        "rotations": rotations, # gaussian_model.get_rotation() if override_rotations is None else override_rotations,
        "cov3D_precomp": None
    }
    color, depth, alpha, radii = renderer(**render_args)
